...
class PollsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poll" do
    assert_difference('Poll.count') do
      post polls_url, params: { poll: { helpful: @poll.helpful, improvement_recommendation: @poll.improvement_recommendation } }
    end
  ...
  test "should update poll" do
    patch poll_url(@poll), params: { poll: { helpful: @poll.helpful, improvement_recommendation: @poll.improvement_recommendation } }
